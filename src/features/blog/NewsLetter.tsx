          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className=" pt-16 lg:pt-0">
              ...
              <p className="lg:text-[16px] text-xs font-normal font-body mb-6 lg:w-full w-[70%] ">
                Get practical tips, helpful insights, and updates from
                SeedFi—delivered fresh to your inbox.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 w-[85%] lg:w-[65%] ">
                <div className="relative flex-1">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-28 rounded-2xl border-[0.4px] border-gray-500 outline-none"
                  />
                  <button
                    type="submit"
                    className="absolute top-1/2 right-3 -translate-y-1/2 bg-[#2A8851] text-white px-2 py-1.5 rounded-lg text-sm sm:text-base"
                  >
                    Subscribe
                  </button>
                </div>
