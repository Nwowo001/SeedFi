...
const Carousel = <T,>({ data, CardComponent, title, subtitle }: CarouselProps<T>) => {
  ...
  const totalPages = Math.ceil((data.length - 1) / cardsPerView);
  ...
  const containerWidth =
    cardWidth > 0
      ? cardsPerView * cardWidth + (cardsPerView ) * 30 + peek
      : "100%";
